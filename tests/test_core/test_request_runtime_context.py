...
def test_request_context_set_update_and_reset():
    ...
    try:
        ...
        assert get_current_request_intent() is None
        ...
        update_request_context(
            ...
            shadow_enabled=True,
            request_intent="set_reminder",
            analytics_tags=["memory_related"],
        ...
        assert get_current_request_intent() == "set_reminder"
        assert get_current_analytics_tags() == ["memory_related"]
    ...
    assert get_current_request_intent() is None
    assert get_current_analytics_tags() is None
