...
def _welcome_result() -> SkillResult:
    ...
    return SkillResult(
        response_text=(
            ...
            "Вот что я умею:\n"
            "• <b>Финансы</b> — расходы, доходы, чеки, бюджеты, аналитика, PDF-отчёты\n"
            "• <b>Почта и Календарь</b> — входящие, отправка email, расписание, события\n"
            "• <b>Задачи</b> — дела, напоминания, списки покупок\n"
            "• <b>Жизнь</b> — еда, напитки, настроение, заметки, план дня\n"
            "• <b>Поиск</b> — вопросы, интернет, карты, YouTube\n"
            "• <b>Тексты</b> — письма, посты, перевод, проверка грамматики\n"
        ...
        if context.family_id and text != "/start":
            return SkillResult(
                response_text=(
                    ...
                    "«проверь почту», «мои задачи», «статистика за неделю»."
                ),
            )
