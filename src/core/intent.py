...
- weekly_digest: еженедельная сводка за неделю ("weekly digest", "weekly summary", \
"итоги недели", "week in review", "how was my week?", "недельный отчёт", \
"сводка за неделю", "what happened this week?")
