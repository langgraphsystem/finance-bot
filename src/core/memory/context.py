...
QUERY_CONTEXT_MAP: dict[str, dict[str, Any]] = {
    ...
    "create_tracker":       {"mem": False, "hist": 2, "sql": False, "sum": False},
    "list_trackers":        {"mem": False, "hist": 1, "sql": False, "sum": False},
    "log_tracker":          {"mem": False, "hist": 2, "sql": False, "sum": False},
    "set_tracker_reminder": {"mem": False, "hist": 2, "sql": False, "sum": False},
