...
async def _classify_with_llm(
    ...
    prompt = (
        ...
        f"ВАЖНО: Верни ТОЛЬКО точное название категории из списка выше. "
        f"НЕ придумывай новые категории и подкатегории. "
        f"Выбери наиболее подходящую категорию из списка."
    )
