...
| Gemini 3 Flash | `gemini-3.1-flash-preview` | OCR, research, summarization |
...
| Agent | Model | Skills |
|-------|-------|--------|
| receipt | gemini-3.1-flash-preview | scan_receipt, scan_document |
...
| research | gemini-3.1-flash-preview | quick_answer, web_search, compare_options, maps_search, youtube_search, price_check, web_action, browser_action |
